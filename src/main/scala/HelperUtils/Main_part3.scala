...
object Main_part3 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    job1.setMapperClass(classOf[Map_part3])
    job1.setReducerClass(classOf[Reduce_part3])
    ...
    job2.setMapperClass(classOf[Map_part3_2])
    job2.setReducerClass(classOf[Reduce_part3_2])
